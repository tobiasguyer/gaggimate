  ...
  return (
    <div className="space-y-6">
      ...
      <div
        ...
        <div class="flex min-h-0 min-w-0 flex-col col-span-10 gap-2 lg:col-span-5 landscape:max-lg:col-span-5 landscape:max-lg:min-h-0">
          {/* LEFT COMPONENT DECK ROW */}
          <Card sm={10} lg={5} className='flex min-h-0 min-w-0 flex-col gap-2 lg:col-span-1 landscape:max-lg:col-span-5 landscape:max-lg:min-h-0'>
            ...
            <div class="card sticky top-4">
              ...
              <details class="collapse collapse-arrow bg-base-300/40 border border-base-content/5 rounded-lg text-xs">
                ...
                <div class="collapse-content pt-1">
                  <pre class="bg-base-300 text-[10px] p-2 rounded overflow-x-auto max-h-200 font-mono">
                    {JSON.stringify({
