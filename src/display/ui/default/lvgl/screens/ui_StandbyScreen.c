...
#define CLOCK_CX       488 / 2          // centre x
#define CLOCK_CY       488 /2          // centre y
// Diese Funktion einmal beim Screen-Init aufrufen
static void drawClockTicks(lv_obj_t *parent)
{
    for (int i = 0; i < 60; i++) {
        float angle_deg = i * 6.0f; // 360/60
        ...
        if (i % 5 == 0) {
            // Stundenstriche: dicker, länger
            outer_r = 220.0f;
            inner_r = 185.0f;
            width   = 8;
        } else {
            // Minutenstriche: dünner, kürzer
            outer_r = 220.0f;
            inner_r = 205.0f;
            width   = 3;
        }
...
static void polar_to_xy(float angle_deg, float radius,
...
void ui_Standby_screen_draw_sbb_clock(const struct tm *t)
{
    ...
    // ---------------- SEC HAND ----------------
    polar_to_xy(sec_angle, 180, &x2, &y2);
    polar_to_xy(sec_angle, -60,   &x1, &y1);
    ...
    // ---------------- MIN HAND ----------------
    polar_to_xy(min_angle, 220, &x2, &y2);
    ...
    // ---------------- HOUR HAND ----------------
    polar_to_xy(hr_angle, 150, &x2, &y2);
...
void ui_StandbyScreen_screen_init(void) {
    ...
    lv_obj_set_x(ui_StandbyScreen, 0);
    lv_obj_set_y(ui_StandbyScreen, 0);
    ...
    lv_obj_add_event_cb(ui_StandbyScreen, scr_unloaded_delete_cb,
                         LV_EVENT_SCREEN_UNLOADED, ui_StandbyScreen_screen_destroy);
    ui_object_set_themeable_style_property(ui_StandbyScreen,
        LV_PART_MAIN | LV_STATE_DEFAULT, LV_STYLE_BG_COLOR, _ui_theme_color_Dark);
        
    ui_object_set_themeable_style_property(ui_StandbyScreen,
        LV_PART_MAIN | LV_STATE_DEFAULT, LV_STYLE_BG_COLOR, _ui_theme_color_NiceWhite);
    ...
    ui_object_set_themeable_style_property(ui_StandbyScreen_time,
        LV_PART_MAIN | LV_STATE_DEFAULT, LV_STYLE_TEXT_COLOR, _ui_theme_color_NiceWhite);
    ui_object_set_themeable_style_property(ui_StandbyScreen_time,
        LV_PART_MAIN | LV_STATE_DEFAULT, LV_STYLE_TEXT_OPA,   _ui_theme_alpha_NiceWhite);
    ...
    ui_object_set_themeable_style_property(ui_StandbyScreen_statusContainer,
        LV_PART_MAIN | LV_STATE_DEFAULT, LV_STYLE_TEXT_COLOR, _ui_theme_color_NiceWhite);
    ui_object_set_themeable_style_property(ui_StandbyScreen_statusContainer,
        LV_PART_MAIN | LV_STATE_DEFAULT, LV_STYLE_TEXT_OPA,   _ui_theme_alpha_NiceWhite);
    ...
    ui_object_set_themeable_style_property(ui_StandbyScreen_wifiIcon,
        LV_PART_MAIN | LV_STATE_DEFAULT, LV_STYLE_BORDER_COLOR, _ui_theme_color_NiceWhite);
    ui_object_set_themeable_style_property(ui_StandbyScreen_wifiIcon,
        LV_PART_MAIN | LV_STATE_DEFAULT, LV_STYLE_BORDER_OPA,   _ui_theme_alpha_NiceWhite);
    ...
    ui_object_set_themeable_style_property(ui_StandbyScreen_bluetoothIcon,
        LV_PART_MAIN | LV_STATE_DEFAULT, LV_STYLE_BORDER_COLOR, _ui_theme_color_NiceWhite);
    ui_object_set_themeable_style_property(ui_StandbyScreen_bluetoothIcon,
        LV_PART_MAIN | LV_STATE_DEFAULT, LV_STYLE_BORDER_OPA,   _ui_theme_alpha_NiceWhite);
    lv_obj_set_style_border_width(ui_StandbyScreen_bluetoothIcon, 10, LV_PART_MAIN | LV_STATE_DEFAULT);
    ui_object_set_themeable_style_property(ui_StandbyScreen_bluetoothIcon,
        LV_PART_MAIN | LV_STATE_DEFAULT, LV_STYLE_IMG_RECOLOR,     _ui_theme_color_Dark);
    ui_object_set_themeable_style_property(ui_StandbyScreen_bluetoothIcon,
        LV_PART_MAIN | LV_STATE_DEFAULT, LV_STYLE_IMG_RECOLOR_OPA, _ui_theme_alpha_Dark);
    ...
    ui_object_set_themeable_style_property(ui_StandbyScreen_updateIcon,
        LV_PART_MAIN | LV_STATE_DEFAULT, LV_STYLE_BORDER_COLOR, _ui_theme_color_Dark);
    ui_object_set_themeable_style_property(ui_StandbyScreen_updateIcon,
        LV_PART_MAIN | LV_STATE_DEFAULT, LV_STYLE_BORDER_OPA,   _ui_theme_alpha_Dark);
drawClockTicks(ui_StandbyScreen);  // <-- aktivieren und Parent übergebe
    // touch icon
    ...
    ui_object_set_themeable_style_property(ui_StandbyScreen_touchIcon,
        LV_PART_MAIN | LV_STATE_DEFAULT, LV_STYLE_IMG_RECOLOR,     _ui_theme_color_Dark);
    ui_object_set_themeable_style_property(ui_StandbyScreen_touchIcon,
        LV_PART_MAIN | LV_STATE_DEFAULT, LV_STYLE_IMG_RECOLOR_OPA, _ui_theme_alpha_Dark);
    ...
    ui_object_set_themeable_style_property(ui_StandbyScreen_mainLabel,
        LV_PART_MAIN | LV_STATE_DEFAULT, LV_STYLE_TEXT_COLOR, _ui_theme_color_Dark);
    ui_object_set_themeable_style_property(ui_StandbyScreen_mainLabel,
        LV_PART_MAIN | LV_STATE_DEFAULT, LV_STYLE_TEXT_OPA,   _ui_theme_alpha_Dark);
    lv_obj_set_style_text_font(ui_StandbyScreen_mainLabel, &lv_font_montserrat_20,
                                LV_PART_MAIN | LV_STATE_DEFAULT);

hour_hand = create_hand(ui_StandbyScreen, lv_color_black(), 17);
min_hand  = create_hand(ui_StandbyScreen, lv_color_black(), 13);
sec_hand  = create_hand(ui_StandbyScreen, lv_color_hex(0xE30613), 5);
