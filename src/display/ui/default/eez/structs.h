...
enum SystemStatusFlowStructureFields {
    ...
    FLOW_STRUCTURE_SYSTEM_STATUS_FIELD_STANDBY_MODE = 14,
    FLOW_STRUCTURE_SYSTEM_STATUS_FIELD_STANDBY_LOGO = 15,
...
struct SystemStatusValue {
    ...
    bool standby_analog_clock() {
        return value.getArray()->values[FLOW_STRUCTURE_SYSTEM_STATUS_FIELD_STANDBY_ANALOG_CLOCK].getBoolean();
    }
