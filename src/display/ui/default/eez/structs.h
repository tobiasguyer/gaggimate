...
enum FlowStructures {
    ...
    FLOW_STRUCTURE_TIME_STRUCT = 16389,
    FLOW_STRUCTURE_TIMER_STRUCT = 16390
};
...
enum FlowArrayOfStructures {
    ...
    FLOW_ARRAY_OF_STRUCTURE_TIME_STRUCT = 81925,
    FLOW_ARRAY_OF_STRUCTURE_TIMER_STRUCT = 81926
};
...
enum SystemStatusFlowStructureFields {
    ...
    FLOW_STRUCTURE_SYSTEM_STATUS_FIELD_VOLUMETRIC_AVAILABLE = 5,
    FLOW_STRUCTURE_SYSTEM_STATUS_FIELD_CONTROLLER_VERSION = 6,
    FLOW_STRUCTURE_SYSTEM_STATUS_FIELD_DISPLAY_VERSION = 7,
    FLOW_STRUCTURE_SYSTEM_STATUS_FIELD_IN_MENU = 8,
    FLOW_STRUCTURE_SYSTEM_STATUS_FIELD_PRESSURE_AVAILABLE = 9,
    FLOW_STRUCTURE_SYSTEM_STATUS_FIELD_BLUETOOTH_SCALES = 10,
    FLOW_STRUCTURE_SYSTEM_STATUS_FIELD_GRIND_AVAILABLE = 11,
    FLOW_STRUCTURE_SYSTEM_STATUS_FIELD_MODE = 12,
    FLOW_STRUCTURE_SYSTEM_STATUS_FIELD_STANDBY_MODE = 13,
    FLOW_STRUCTURE_SYSTEM_STATUS_FIELD_STANDBY_LOGO = 14,
    FLOW_STRUCTURE_SYSTEM_STATUS_FIELD_STANDBY_STATUS = 15,
    FLOW_STRUCTURE_SYSTEM_STATUS_FIELD_STANDBY_TOUCH_ICON = 16,
    FLOW_STRUCTURE_SYSTEM_STATUS_FIELD_STANDBY_ANALOG_CLOCK = 17,
    FLOW_STRUCTURE_SYSTEM_STATUS_FIELD_STANDBY_BINARY_CLOCK = 18,
    FLOW_STRUCTURE_SYSTEM_STATUS_FIELD_STANDBY_DIGITAL_CLOCK = 19,
    FLOW_STRUCTURE_SYSTEM_STATUS_FIELD_QRCODE_CONTENT = 20,
    FLOW_STRUCTURE_SYSTEM_STATUS_FIELD_NETWORK = 21,
    FLOW_STRUCTURE_SYSTEM_STATUS_FIELD_IP = 22,
    FLOW_STRUCTURE_SYSTEM_STATUS_FIELD_AP_ACTIVE = 23,
...
enum BoilerFlowStructureFields {
    ...
    FLOW_STRUCTURE_BOILER_FIELD_CURRENT_TEMPERATURE2 = 6,
...
enum time_structFlowStructureFields {
...
enum timer_structFlowStructureFields {
    FLOW_STRUCTURE_TIMER_STRUCT_FIELD_CURRENT = 0,
    FLOW_STRUCTURE_TIMER_STRUCT_FIELD_SEC = 1,
    FLOW_STRUCTURE_TIMER_STRUCT_FIELD_MIN = 2,
    FLOW_STRUCTURE_TIMER_STRUCT_FIELD_HOUR = 3,
    FLOW_STRUCTURE_TIMER_STRUCT_FIELD_TIMER_COUNT_TO = 4,
    FLOW_STRUCTURE_TIMER_STRUCT_FIELD_TIMER_SET_AT = 5,
    FLOW_STRUCTURE_TIMER_STRUCT_FIELD_DISPLAY_TIMER = 6,
    FLOW_STRUCTURE_TIMER_STRUCT_NUM_FIELDS
};
...
struct SystemStatusValue {
    ...
    int standby_mode() {
        return value.getArray()->values[FLOW_STRUCTURE_SYSTEM_STATUS_FIELD_STANDBY_MODE].getInt();
    }
    void standby_mode(int standby_mode) {
        value.getArray()->values[FLOW_STRUCTURE_SYSTEM_STATUS_FIELD_STANDBY_MODE] = IntegerValue(standby_mode);
    }
    
    bool standby_logo() {
        return value.getArray()->values[FLOW_STRUCTURE_SYSTEM_STATUS_FIELD_STANDBY_LOGO].getBoolean();
    }
    void standby_logo(bool standby_logo) {
        value.getArray()->values[FLOW_STRUCTURE_SYSTEM_STATUS_FIELD_STANDBY_LOGO] = BooleanValue(standby_logo);
    }
    
    bool standby_status() {
        return value.getArray()->values[FLOW_STRUCTURE_SYSTEM_STATUS_FIELD_STANDBY_STATUS].getBoolean();
    }
    void standby_status(bool standby_status) {
        value.getArray()->values[FLOW_STRUCTURE_SYSTEM_STATUS_FIELD_STANDBY_STATUS] = BooleanValue(standby_status);
    }
    
    bool standby_touch_icon() {
        return value.getArray()->values[FLOW_STRUCTURE_SYSTEM_STATUS_FIELD_STANDBY_TOUCH_ICON].getBoolean();
    }
    void standby_touch_icon(bool standby_touch_icon) {
        value.getArray()->values[FLOW_STRUCTURE_SYSTEM_STATUS_FIELD_STANDBY_TOUCH_ICON] = BooleanValue(standby_touch_icon);
    }
    
    int standby_analog_clock() {
        return value.getArray()->values[FLOW_STRUCTURE_SYSTEM_STATUS_FIELD_STANDBY_ANALOG_CLOCK].getInt();
    }
    void standby_analog_clock(int standby_analog_clock) {
        value.getArray()->values[FLOW_STRUCTURE_SYSTEM_STATUS_FIELD_STANDBY_ANALOG_CLOCK] = IntegerValue(standby_analog_clock);
    }
...
struct BoilerValue {
    ...
    float current_temperature2() {
        return value.getArray()->values[FLOW_STRUCTURE_BOILER_FIELD_CURRENT_TEMPERATURE2].getFloat();
    }
    void current_temperature2(float current_temperature2) {
        value.getArray()->values[FLOW_STRUCTURE_BOILER_FIELD_CURRENT_TEMPERATURE2] = FloatValue(current_temperature2);
    }
};
...
struct time_structValue {
    Value value;
    
    time_structValue() {
        value = Value::makeArrayRef(FLOW_STRUCTURE_TIME_STRUCT_NUM_FIELDS, FLOW_STRUCTURE_TIME_STRUCT, 0);
    }
    
    time_structValue(Value value) : value(value) {}
    ...
    int sec() {
        return value.getArray()->values[FLOW_STRUCTURE_TIME_STRUCT_FIELD_SEC].getInt();
    }
    void sec(int sec) {
        value.getArray()->values[FLOW_STRUCTURE_TIME_STRUCT_FIELD_SEC] = IntegerValue(sec);
    }
    
    int min() {
        return value.getArray()->values[FLOW_STRUCTURE_TIME_STRUCT_FIELD_MIN].getInt();
    }
    void min(int min) {
        value.getArray()->values[FLOW_STRUCTURE_TIME_STRUCT_FIELD_MIN] = IntegerValue(min);
    }
    
    int hour() {
        return value.getArray()->values[FLOW_STRUCTURE_TIME_STRUCT_FIELD_HOUR].getInt();
    }
    void hour(int hour) {
    ...
    bool analog_numerals() {
        return value.getArray()->values[FLOW_STRUCTURE_TIME_STRUCT_FIELD_ANALOG_NUMERALS].getBoolean();
    }
...
typedef ArrayOf<time_structValue, FLOW_ARRAY_OF_STRUCTURE_TIME_STRUCT> ArrayOftime_structValue;
struct timer_structValue {
    Value value;
    
    timer_structValue() {
        value = Value::makeArrayRef(FLOW_STRUCTURE_TIMER_STRUCT_NUM_FIELDS, FLOW_STRUCTURE_TIMER_STRUCT, 0);
    }
    
    timer_structValue(Value value) : value(value) {}
    ...
    int current() {
        return value.getArray()->values[FLOW_STRUCTURE_TIMER_STRUCT_FIELD_CURRENT].getInt();
    }
    void current(int current) {
        value.getArray()->values[FLOW_STRUCTURE_TIMER_STRUCT_FIELD_CURRENT] = IntegerValue(current);
    }
    
    int sec() {
        return value.getArray()->values[FLOW_STRUCTURE_TIMER_STRUCT_FIELD_SEC].getInt();
    }
    void sec(int sec) {
        value.getArray()->values[FLOW_STRUCTURE_TIMER_STRUCT_FIELD_SEC] = IntegerValue(sec);
    }
    
    int min() {
        return value.getArray()->values[FLOW_STRUCTURE_TIMER_STRUCT_FIELD_MIN].getInt();
    }
    void min(int min) {
        value.getArray()->values[FLOW_STRUCTURE_TIMER_STRUCT_FIELD_MIN] = IntegerValue(min);
    }
    
    int hour() {
        return value.getArray()->values[FLOW_STRUCTURE_TIMER_STRUCT_FIELD_HOUR].getInt();
    }
    void hour(int hour) {
        value.getArray()->values[FLOW_STRUCTURE_TIMER_STRUCT_FIELD_HOUR] = IntegerValue(hour);
    }
    
    int timer_count_to() {
        return value.getArray()->values[FLOW_STRUCTURE_TIMER_STRUCT_FIELD_TIMER_COUNT_TO].getInt();
    }
    void timer_count_to(int timer_count_to) {
        value.getArray()->values[FLOW_STRUCTURE_TIMER_STRUCT_FIELD_TIMER_COUNT_TO] = IntegerValue(timer_count_to);
    }
    
    int timer_set_at() {
        return value.getArray()->values[FLOW_STRUCTURE_TIMER_STRUCT_FIELD_TIMER_SET_AT].getInt();
    }
    void timer_set_at(int timer_set_at) {
        value.getArray()->values[FLOW_STRUCTURE_TIMER_STRUCT_FIELD_TIMER_SET_AT] = IntegerValue(timer_set_at);
    }
    
    bool display_timer() {
        return value.getArray()->values[FLOW_STRUCTURE_TIMER_STRUCT_FIELD_DISPLAY_TIMER].getBoolean();
    }
    void display_timer(bool display_timer) {
        value.getArray()->values[FLOW_STRUCTURE_TIMER_STRUCT_FIELD_DISPLAY_TIMER] = BooleanValue(display_timer);
    }
};

typedef ArrayOf<timer_structValue, FLOW_ARRAY_OF_STRUCTURE_TIMER_STRUCT> ArrayOftimer_structValue;
